...
int main() {
  ...
  /*
  Since the exploit is solely based on the underflow due to |placeholder| > |text|, all we need to handle is that single exception.
  */
  if(placeholder.size() > text.size()) {
